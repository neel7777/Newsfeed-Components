...
*/
function articleMaker(title, date, author, firstParagraph, secondParagraph, thirdParagraph) {
...
data.map(el => {
    articles.appendChild(articleMaker(el.title, el.date, el.author, el.firstParagraph, el.secondParagraph, el.thirdParagraph))
});